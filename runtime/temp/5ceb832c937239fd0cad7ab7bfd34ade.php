<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/www/wwwroot/xjc.demo.hongcd.com/public/../application/admin/view/daili/daren/add.html";i:1678082053;s:75:"/www/wwwroot/xjc.demo.hongcd.com/application/admin/view/layout/default.html";i:1588765310;s:72:"/www/wwwroot/xjc.demo.hongcd.com/application/admin/view/common/meta.html";i:1588765310;s:74:"/www/wwwroot/xjc.demo.hongcd.com/application/admin/view/common/script.html";i:1588765310;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" readonly="readonly" class="form-control" id="pid" name="row[pid]" value="<?php echo $id; ?>" />
        </div>
    </div>
    <div class="form-group">
        <label for="islx" class="control-label col-xs-12 col-sm-2"><?php echo __('类型'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="text" readonly="readonly" class="form-control" id="islx" name="row[islx]" value="2" />
        </div>
    </div>
    <div class="form-group">
